...
REMOVE_WATERMARKS: bool = os.getenv("VAR_REMOVE_WATERMARKS", "").lower() in ("true",)
DOWNLOAD_VIDEOS: bool = os.getenv("VAR_DOWNLOAD_VIDEOS", "").lower() in ("true",)
DOWNLOAD_VK_CLIPS: bool = os.getenv("VAR_DOWNLOAD_VK_CLIPS", "").lower() in ("true",)
